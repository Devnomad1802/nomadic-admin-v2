...
import { useDeleteReviewMutation } from "../../Redux/services";
const Transition = React.forwardRef((props, ref) => {
  return <Slide direction="up" ref={ref} {...props} />;
});

const DeleteReview = ({ delModal, setDelModal, deletripId }) => {
  ...
  const handleDeleteTrip = async () => {
    try {
      setLoading(true);
      const res = await deleteReview({ _id: deletripId }).unwrap();
      console.log("res...", res);
      setLoading(false);
      setDelModal(false);
