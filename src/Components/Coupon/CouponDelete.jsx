...
import { useDeleteCouponMutation } from "../../Redux/services/coupenApi";
...
const CouponDelete = ({ delModal, setDelModal, deletripId }) => {
  ...
  const handleDeleteTrip = async () => {
    try {
      setLoading(true);
      const res = await deleteCoupon({ _id: deletripId }).unwrap();
      console.log("res...", res);
      setLoading(false);
      setDelModal(false);
