...
import { useDeleteTeamMemberMutation } from "../../Redux/services/aboutApis";
...
const AboutUsModal = ({ delModal, setDelModal, deletripId }) => {
  ...
  const [AboutUsModal] = useDeleteTeamMemberMutation();

  const handleDeleteTrip = async () => {
    try {
      setLoading(true);
      const res = await AboutUsModal({ _id: deletripId }).unwrap();
      console.log("res...", res);
      setLoading(false);
      setDelModal(false);
