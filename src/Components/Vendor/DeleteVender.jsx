...
import { useDeleteVendorMutation } from "../../Redux/services/vanderApi";
const Transition = React.forwardRef((props, ref) => {
  return <Slide direction="up" ref={ref} {...props} />;
});

const DeleteVender = ({ delModal, setDelModal, deleteVender }) => {
  ...
  const handleDeleteTrip = async () => {
    try {
      setLoading(true);
      const res = await deleteVendor({ _id: deleteVender }).unwrap();
      console.log("res...", res);
      setLoading(false);
      setDelModal(false);
