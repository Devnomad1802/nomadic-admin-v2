...
import BookingVendors from "./BookingVendors";
...
export default function VenderTabs() {
  const location = useLocation();
  const { vender } = location.state || {};
    ...
    >
      ...
      >
        ...
        >
          ...
          <AntTab label="Bookings" {...a11yProps(1)} />
        </Tabs>
      </Box>
      <Box
        // className="scroolbox"
